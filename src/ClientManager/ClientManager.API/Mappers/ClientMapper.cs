...
{
    public static ClientResponse ToResponse(Client client) => new(client.Id, client.FirstName!, client.LastName!, client.Email!, client.IsArchived!);

    public static ClientResponse ToResponse(CreateClient client) => new(client.Id, client.FirstName!, client.LastName!, client.Email!, client.IsArchived!);
